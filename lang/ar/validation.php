...
return [
    ...
    */
    ...
    'hex_color' => 'يجب أن يكون :attribute لونًا بنظام سداسي عشري صالحًا.',
    ...
    'lowercase' => 'يجب أن تكون جميع أحرف :attribute صغيرة.',
    'lt' => [
    ...
    'missing_if' => 'يجب أن يكون :attribute مفقودًا عندما تكون قيمة :other هي :value.',
    'missing_unless' => 'يجب أن يكون :attribute مفقودًا إلا إذا كانت قيمة :other هي :value.',
    ...
    'password' => [
        ...
        'mixed' => 'يجب أن تحتوي كلمة المرور على حرف كبير وآخر صغير على الأقل.',
    ...
    'uppercase' => 'يجب أن تكون جميع أحرف :attribute كبيرة.',
